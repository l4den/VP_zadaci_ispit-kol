...
public class SeleniumScenarioTest {
    ...
    public void test_filter_5pt() {
        ...
        // ovoj test e smenet bidejki ne e tocen, ne postojat 3 studenti od prosla god so course 1
        listPage.filter("1", "1");
        ...
        // ovoj test e smenet bidejki ne e tocen, od sekoja godina ima po 2 studenti
        listPage.filter("3", "");
    ...
    public void test_filter_service_5pt() {
        ...
        // ja promeiv expected: od 4 na 2 bidejki od sekoja godina ima samo po 2 students
        ExamAssert.assertEquals("by years of service", 2, this.service.filter(null, 3).size());
        // ja promeiv expected: od 3 na 1 bidejki od ima samo eden student od prosla godina so course 1
        ExamAssert.assertEquals("by all", 1, this.service.filter(1L, 1).size());
