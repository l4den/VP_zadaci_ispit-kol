...
//dodadov entity za da se napravi tabela vo data baza
@Entity
public class VirtualServer {
    ...
    // avtomatski generirano ID za sekoj VirtualMachine
    @Id
    @GeneratedValue
    private Long id;
    ...
    // mora da se dodade ako promenlivata e od tip Enum
    @Enumerated(EnumType.STRING)
    private OSType OSType;

    // eden VM moze da ima povekje sopstvenici
    // eden sopstvenik moze da ima povekje VMs
    // mora da ima FetchType. inace nema da raboti
